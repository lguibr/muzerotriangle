...
# REMOVED: from .types import Experience
...
class SumTree:
    ...
    def __init__(self, capacity: int):
        ...
        # Data storage: Allow storing any object (like TrajectoryStep)
        self.data = np.zeros(capacity, dtype=object)
        self.data_pointer = 0
        self.n_entries = 0
        self._max_priority = 1.0

    def add(self, priority: float, data: object):  # Changed type hint from Experience
    ...
    def get_leaf(self, value: float) -> tuple[int, float, object]:  # Changed type hint
